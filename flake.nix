{
  ...
  in {
    ...
    nixosConfigurations = {
      ...
      myzima3 = nixpkgs.lib.nixosSystem {
        specialArgs = {
          inherit inputs outputs;
          hostname = "myzima3";
        };
    ...
    homeConfigurations = {
      ...
      "awhawks@myzima3" = home-manager.lib.homeManagerConfiguration {
        pkgs = nixpkgs.legacyPackages."x86_64-linux";
        extraSpecialArgs = {
          inherit inputs outputs;
          hostname = "myzima3";
        };
        modules = [ ./home/awhawks/myzima3.nix ];
      };
    };
      ...
      myzima3 = {
        ...
        profiles = {
          system = {
            ...
            confirmTimeout = 30;
            path = deploy-rs.lib.x86_64-linux.activate.nixos
                   self.nixosConfigurations.myzima3;
          };
        };
      };
    };
