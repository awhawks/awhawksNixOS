...
{ 
  ...
  services.openssh = {
    ...
    settings = {
      PermitRootLogin = "yes";
      # Optional: Allow password authentication (default is true, but often explicitly set)
      PasswordAuthentication = false;
      X11Forwarding = true;
      # Optional: Further secure your setup by disabling root login with a password
